 ...
 */
	protected function _authArray() {
		return array(
			'method' => 'OAuth',
			'oauth_token' => Configure::read('Twitter.oauthToken'),
			'oauth_token_secret' => Configure::read('Twitter.oauthTokenSecret'),
			'oauth_consumer_key' => Configure::read('Twitter.consumerKey'),
			'oauth_consumer_secret' => Configure::read('Twitter.consumerSecret')
		);
	}
 ...
 */
	public function userTimeline($param,$count) {
		$body = array();
		if (is_numeric($param)) {
			$body['user_id'] = $param;
