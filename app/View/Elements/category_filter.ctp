		...
		<ul id="filter-list" class="category-<?php echo $selected_parent_id;?>">
			...
			<?php foreach($sub_category_list as $sub_category): ?>
				...
				category-<?php echo $sub_category['Category']['parent_id']; ?>">
					<a href="<?php echo $this->Html->url( array('controller'=>'services', 'action'=>'index', $selected_parent_slug, $sub_category['Category']['slug']) ); ?>" class="ajax" data-cat="<?php echo $sub_category['Category']['slug'];?>">
