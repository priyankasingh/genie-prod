        ...
        if ($Model->hasField($this->__settings[$Model->alias]['slug']) && ($this->__settings[$Model->alias]['overwrite'] || empty($Model->id)))
        {
            ...
            foreach($this->__settings[$Model->alias]['label'] as $field)
            {
                if (!empty($Model->data[$Model->alias][$field]))
                {
					...
					$fieldValue = is_array( $Model->data[$Model->alias][$field] ) ? $Model->data[$Model->alias][$field][ Configure::read('Config.language') ]: $Model->data[$Model->alias][$field];
                    $label .= $prepend . $fieldValue;
                }
            }
